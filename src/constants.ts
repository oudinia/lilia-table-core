...
export const ALIGN_NEXT: Record<Align, Align> = { l: 'c', c: 'r', r: 'l' };
export const ALIGN_LABEL: Record<Align, string> = { l: 'Left', c: 'Center', r: 'Right' };

export const BORDERS: readonly { v: Borders; label: string }[] = [
...
export const alignToTextAlign = (a: Align): 'left' | 'center' | 'right' =>
